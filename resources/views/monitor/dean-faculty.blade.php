...
<div class="container-fluid">
    ...
    <div class="row mb-4">
        <div class="col-12">
            <h2><i class="fas fa-users me-2"></i>Monitor Faculty</h2>
            <p class="text-muted">Overview of faculty compliance in {{ $department->name }}</p>
        </div>
    </div>
                ...
                <div class="card-body">
                    <div class="row align-items-center">
                        <div class="col-md-8">
                            ...
                            <p class="mb-0">{{ $department->description ?? 'Department Overview' }}</p>
                        </div>
        ...
        <div class="col-md-6 col-lg-4 mb-4">
            <div class="card h-100">
                ...
                <div class="card-footer">
                    <a href="{{ route('monitor.dean.program.faculty', $programData['program']) }}" class="btn btn-primary btn-sm w-100">
