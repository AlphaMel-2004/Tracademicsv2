                            ...
                            <table class="table table-striped table-hover mb-0 semester-requirements-table" id="semester-requirements-table">
                                <thead class="table-light">
                                    <tr>
                                        ...
                                        <th style="width: 15%;">Document Status</th>
                                        <th style="width: 10%;">Self-Evaluation Status</th>
                                ...
                                <tbody>
                                    ...
                                    <tr data-compliance-id="{{ $compliance->id }}">
                                        ...
                                        <td>
                                            @php
                                                $approvalStatus = $compliance->approval_status ?? 'draft';
                                                $statusMap = [
                                                ...
                                                $programHeadStatus = $compliance->program_head_approval_status ?? 'pending';
                                                $deanStatus = $compliance->dean_approval_status ?? 'pending';
